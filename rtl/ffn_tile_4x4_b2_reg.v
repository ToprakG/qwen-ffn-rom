...
module ffn_tile #(
  ...
  localparam [7:0] W_ROW0 = 8'h0c;
  localparam [7:0] W_ROW1 = 8'h40;
  localparam [7:0] W_ROW2 = 8'hc4;
  localparam [7:0] W_ROW3 = 8'hc4;
...
module ffn_tile_reg (
  ...
  output reg  signed [48-1:0] y_flat
);
  reg  signed [32-1:0] x_q;
  wire signed [48-1:0] y_c;
  ffn_tile u_comb (
    .x_flat(x_q),
    .y_flat(y_c)
  );
