// Hardwired mat-vec tile 4x4, signed 4-bit weights.
...
module ffn_tile #(
  ...
  localparam [15:0] W_ROW0 = 16'h2390;
  localparam [15:0] W_ROW1 = 16'h72d2;
  localparam [15:0] W_ROW2 = 16'h924f;
  localparam [15:0] W_ROW3 = 16'h9243;
  localparam [63:0] WROM = {
    W_ROW3,
    W_ROW2,
    W_ROW1,
    W_ROW0
...
module ffn_tile_reg (
  input  wire clk,
  input  wire signed [32-1:0] x_flat,
  output reg  signed [56-1:0] y_flat
);
  reg  signed [32-1:0] x_q;
  wire signed [56-1:0] y_c;
  ffn_tile u_comb (
    .x_flat(x_q),
    .y_flat(y_c)
  );
