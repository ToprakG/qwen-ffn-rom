// Hardwired mat-vec tile 4x4, signed 3-bit weights.
...
module ffn_tile #(
  ...
  localparam [11:0] W_ROW0 = 12'h268;
  localparam [11:0] W_ROW1 = 12'h679;
  localparam [11:0] W_ROW2 = 12'ha50;
  localparam [11:0] W_ROW3 = 12'ha51;
  localparam [47:0] WROM = {
    W_ROW3,
    W_ROW2,
    W_ROW1,
    W_ROW0
...
module ffn_tile_reg (
  ...
  output reg  signed [52-1:0] y_flat
);
  reg  signed [32-1:0] x_q;
  wire signed [52-1:0] y_c;
  ffn_tile u_comb (
    .x_flat(x_q),
    .y_flat(y_c)
  );
